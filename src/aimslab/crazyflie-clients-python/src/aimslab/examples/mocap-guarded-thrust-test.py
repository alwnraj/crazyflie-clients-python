...
# Raw Crazyflie thrust is in the 0..65535 range. The upper limit is deliberately
# below the user's observed approximate hover point until this test is tuned.
MIN_THRUST = 0
START_THRUST = 20000
MAX_THRUST = 34000
THRUST_STEP = 400
...
def run_guarded_thrust_test(cf, start_position):
    ...
    hold_thrust = min(current_thrust, HOVER_THRUST)
